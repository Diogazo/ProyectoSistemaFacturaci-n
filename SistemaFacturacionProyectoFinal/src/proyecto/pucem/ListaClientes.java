...
public class ListaClientes extends JDialog {
	...
	private void enviarCliente(JLabel lblCedula, JLabel lblNombres, JLabel lblApellidos, JLabel lblTelefono, JLabel lblEmail, JLabel lblDireccion) {
		...
		lblNombres.setText("Nombre: "+FrmCliente.getClientes().get(indiceCliente).getNombre());
		lblApellidos.setText("Apellido: "+FrmCliente.getClientes().get(indiceCliente).getApellido());
		...
		lblDireccion.setText("Diección: "+FrmCliente.getClientes().get(indiceCliente).getDireccion());
		dispose();
	}
